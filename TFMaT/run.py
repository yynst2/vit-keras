...
"""
Script to train FC MNIST model. # todo: adapting to TFMaT
"""
import argparse
import os
import sys
...
from modelzoo.TFMaT.tf.data import eval_input_fn, train_input_fn   # todo: only directory change, scripts not adapted yet
from modelzoo.TFMaT.tf.model import model_fn
from modelzoo.TFMaT.tf.utils import (
    DEFAULT_YAML_PATH,
